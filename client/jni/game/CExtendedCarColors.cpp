...
void CExtendedCarColors::ApplyPatches_level0()
{
	...
	unProtect(SA_ADDR(0x5CF418));
	*(CRGBA * *)(SA_ADDR(0x5CF418)) = &ms_vehicleColourTable[0];
#ifdef _CDEBUG
	Log(OBFUSCATE("Applied car cols patch"));
#endif
}
...
{
#ifdef _CDEBUG
	Log(OBFUSCATE("Returned color %d %d %d %d %d"), id, ms_vehicleColourTable[id].A, ms_vehicleColourTable[id].B, ms_vehicleColourTable[id].G, ms_vehicleColourTable[id].R);
#endif
