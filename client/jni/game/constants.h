...
constexpr float MAX_LOD_DISTANCE = 20.0f;
constexpr float MAX_LOWLOD_DISTANCE = 20.0f;

/*constexpr float MAX_LOD_DISTANCE = 150.0f;
constexpr float MAX_LOWLOD_DISTANCE = 150.0f;*/

constexpr float MAX_FADING_DISTANCE = 20.0f;
constexpr float MAX_STREAMING_DISTANCE = 40.0f;

//constexpr float MAX_INVISIBLE_ENTITY_DISTANCE = 30.0f;
//constexpr float MAX_INVISIBLE_VEHICLE_DISTANCE = 100.0f;
constexpr float MAX_INVISIBLE_ENTITY_DISTANCE = 25.0f;
constexpr float MAX_INVISIBLE_VEHICLE_DISTANCE = 25.0f;

constexpr float MAX_STREAMING_RADIUS_SQUARED = 10000.0f;
constexpr float STREAMING_ANGLE_THRESHOLD_RAD = 0.36f;
constexpr float MAX_BIGBUILDING_STREAMING_RADIUS_SQUARED = 30000.0f; // 50000
constexpr float BIGBUILDING_STREAMING_ANGLE_THRESHOLD_RAD = 0.6f;
