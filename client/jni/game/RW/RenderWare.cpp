...
RwTexture *(*RwTextureSetMaskName)(RwTexture *texture, char const *text);
RwTexture *(*RwTextureSetName)(RwTexture *texture, char const *text);
...
void InitRenderWareFunctions()
{
	...
	//
	SetFuncAddr(&RwTextureSetRaster				, g_libGTASA + 0x1B19D0 + 1); // _Z18RwTextureSetRasterP9RwTextureP8RwRaster
	SetFuncAddr(&RwTextureSetMaskName				, g_libGTASA + 0x1B1C10 + 1); //.text:001B1C10 _Z20RwTextureSetMaskNameP9RwTexturePKc
    SetFuncAddr(&RwTextureSetName				, g_libGTASA + 0x1B1BB4 + 1);
