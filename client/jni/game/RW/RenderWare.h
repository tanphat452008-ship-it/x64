...
extern RwTexture *(*RwTextureSetMaskName)(RwTexture *texture, char const *text);//.text:001B1C10 _Z20RwTextureSetMaskNameP9RwTexturePKc RwTextureSetMaskName(RwTexture *, char const*)
extern RwTexture *(*RwTextureSetName)(RwTexture *texture, char const *text);
