...
{
	char *cRet = ((char * (*)(char *))(g_libGTASA+0x33DB7C+1))((char *)szAnimFile);
	if(cRet == 0) return -1;

	//return (int)cRet[0x10];
	return ScriptCommand(&is_animation_loaded, szAnimFile);
}

void CGame::RequestAnimation(char *szAnimFile)
{
	char cRet = ((char (*)(char *))(g_libGTASA+0x33DBCC+1))((char *)szAnimFile);
	if(cRet == 0) return;

	//RequestModel(cRet + 0x63E7, MISSION_REQUIRED);
