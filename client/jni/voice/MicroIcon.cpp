...
bool MicroIcon::Init() noexcept
{
    ...
    try
    {
        MicroIcon::tPassiveIcon = (RwTexture*)LoadTextureFromDB("gtasa", "voice_off");
        MicroIcon::tActiveIcon = (RwTexture*)LoadTextureFromDB("gtasa", "voice_on");
        MicroIcon::tMutedIcon = (RwTexture*)LoadTextureFromDB("gtasa", "voice_off");//voice_off
    }
