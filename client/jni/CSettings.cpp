...
void CSettings::Save(int iIgnoreCategory)
{
	...
	ini_table_create_entry_as_int(config, OBFUSCATE("client"), OBFUSCATE("server"), m_Settings.iServer);
	ini_table_create_entry(config, OBFUSCATE("gui"), OBFUSCATE("Font"), m_Settings.szFont);
	ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("FOV"), m_Settings.fov_player);
...
void CSettings::LoadSettings(const char* szNickName, int iChatLines)
{
	...
	snprintf(m_Settings.szNickName, sizeof(m_Settings.szNickName), OBFUSCATE("Quang_Huy"), rand() % 1000, rand() % 1000);
	...
	m_Settings.fButtonMicrophoneSize = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("MicrophoneSize"), 30.0f);
	m_Settings.fButtonMicrophoneX = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("MicrophoneX"), 1520.0f);
	m_Settings.fButtonMicrophoneY = ini_table_get_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("MicrophoneY"), 480.0f);
	...
	m_Settings.iServer = ini_table_get_entry_as_int(config, OBFUSCATE("client"), OBFUSCATE("server"), 0);
	m_Settings.fov_player = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("FOV"), 75);
	...
	m_Settings.iOutfitGuns = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("outfit"), 0);
	...
	m_Settings.iSkyBox = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("ctimecyc"), 0);
	m_Settings.iSnow = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("snow"), 0);
	...
	m_Settings.iSkyBox = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("skybox"), 0);
	m_Settings.iTextDraw = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("textdraw"), 1);
