...
public:
	...
	/// \pre Must be called before Initialise
	...
	/// \pre Requires that you first call Initialise
	...
	/// \pre The sender and recipient must already be started via a successful call to Initialise()
