package com.samp.online.gui.dialogs;
...
import com.samp.online.gui.util.CustomRecyclerView;
...
public class Dialog {
    ...
    public void show(int dialogId, int dialogTypeId, String caption, String content, String leftBtnText, String rightBtnText) {
        ...
        if (dialogTypeId == 3)
        {
            ((TextView) this.mLeftBtn.getChildAt(0)).setText(Utils.transfromColors("Dong y"));
            ((TextView) this.mRightBtn.getChildAt(0)).setText(Utils.transfromColors("Dong"));
        }
