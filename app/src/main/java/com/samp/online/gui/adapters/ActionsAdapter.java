package com.samp.online.gui.adapters;
...
import com.samp.online.gui.dialogs.DialogAdapter;
import com.samp.online.gui.models.Actions;
import com.samp.online.gui.models.Donatee;
    ...
    public void onBindViewHolder(@NonNull DonateViewHolder holder, int position) {
        ...
        holder.auto_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NvEventQueueActivity.getInstance().buy_carpodtv(action.get(holder.getAdapterPosition()).getCost(), action.get(holder.getAdapterPosition()).getId());
                NvEventQueueActivity.getInstance().getNameOfCar(action.get(holder.getAdapterPosition()).getName() + "\n" + action.get(holder.getAdapterPosition()).getName2());
            }
        });
    }
    @Override
