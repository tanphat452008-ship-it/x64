...
public class DialogClientSettings extends DialogFragment {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        adapter.addFragment("BASIC",DialogClientSettingsCommonFragment.createInstance("common"));
        ...
        //adapter.addFragment("COLOR", DialogClientSettingsColorFragment.createInstance("colors"));
        //adapter.addFragment("คนแรก", DialogClientSettingsFPSFragment.createInstance("fps").setRoot((ViewGroup)rootview.findViewById(R.id.ll_settings_root)));
        //adapter.addFragment("WEAPON", DialogClientSettingsWeaponsFragment.createInstance("weapons").setRoot((ViewGroup)rootview.findViewById(R.id.ll_settings_root)));
